      ...
      >
        ...
        <div className="relative z-20 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between flex-wrap gap-2">
            <span
              className={`px-3 py-1 rounded-full text-[11px] font-bold tracking-wider uppercase border shadow-sm backdrop-blur-md ${theme.badgeBg} ${theme.badgeText}`}
            >
            ...
            >
              ...
              <span className="text-xs font-bold">{timezone.city}</span>
        ...
        <div className="relative z-20 my-auto py-4 sm:py-6 flex flex-col items-center justify-center text-center">
          {/* Main Digital Clock */}
          ...
          {isSecondary ? (
            <motion.div
              className={`mt-5 w-full max-w-md p-4 sm:p-5 rounded-2xl border text-left shadow-xl backdrop-blur-2xl ${
                !theme.isDarkText
            ...
            >
              ...
              <div className="flex items-start justify-between gap-3">
                <div>
                  <div className="text-[11px] font-bold uppercase tracking-wider opacity-70 flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 opacity-80 text-blue-500" />
                    <span>Time Offset vs {referenceTimezone.label.split(" ")[0]} ({referenceTimezone.id === "Asia/Kolkata" ? "IST" : referenceTimezone.city})</span>
                  </div>
                  <div className="text-base sm:text-lg font-black mt-0.5 text-blue-600 dark:text-blue-400">
              ...
              <div className="mt-3 pt-3 border-t border-current/15 space-y-1.5 text-xs">
                ...
                <div className="flex items-center gap-2 opacity-85">
                  <AlertCircle className="w-4 h-4 shrink-0 opacity-80 text-amber-500" />
                  <span className="font-medium">{dialData.dst.upcomingShiftText}</span>
                </div>
              </div>
            </motion.div>
          ) : (
            ...
            <div
              className={`mt-3 px-3.5 py-1.5 rounded-full text-xs font-semibold border backdrop-blur-md shadow-sm ${
                !theme.isDarkText
